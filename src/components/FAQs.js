...
export default () => {
    ...
    const faqsList = [
        ...
        },
        {
            ...
            a: "Yes, you can fully customize our pre-built templates to match your brand. You can change colors, fonts, images, and layout to ensure your website reflects your unique style and branding. The drag-and-drop interface makes it easy to adjust elements and preview changes in real-time."
        },
        {
        ...
        },
        {
            ...
            a: "No technical skills are required to use JustPrompt. Our platform is designed to be user-friendly and intuitive, allowing anyone to create a professional website using our drag-and-drop interface. Pre-built templates and easy integrations further simplify the process."
        },
        {
        ...
        {
            q: "Is my website secure with JustPrompt?",
            a: "Yes, security is a top priority for us. All websites built with JustPrompt include SSL encryption to protect your data and ensure secure transactions for your customers. We also perform regular security updates and offer features like secure payment gateways to safeguard your website against threats."
        }
    ];
