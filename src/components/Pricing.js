...
export default function Pricing() {
  return (
<main className="bg-green-50 " id='pricing'>
  ...
  <div className="max-w-md mx-auto mb-14 text-center mt-5">
    <h1 className="text-4xl font-semibold mb-6 lg:text-5xl">
      <span className="text-green-400">Flexible</span> Plans
    </h1>
  ...
  <div className="flex flex-col justify-between items-center lg:flex-row lg:items-start">
    <div className="w-full flex-1 mt-8 p-8 order-2 bg-white shadow-xl rounded-3xl sm:w-96 lg:w-full lg:order-1 lg:rounded-r-none">
      ...
      <ul className="mb-7 font-medium text-gray-500">
        <li className="flex text-lg mb-2">
          ...
          <span className="ml-3">
            Essential <span className="text-black">website builder tools</span>
          </span>
        </li>
        <li className="flex text-lg mb-2">
          <img src="https://res.cloudinary.com/williamsondesign/check-grey.svg" />
      ...
      <a
        href="#/"
        className="flex justify-center items-center bg-green-400 rounded-xl py-5 px-4 text-center text-white text-xl"
      >
        Choose Plan
        <img
    ...
    <div className="w-full flex-1 p-8 order-1 shadow-xl rounded-3xl bg-gray-900 text-gray-400 sm:w-96 lg:w-full lg:order-2 lg:mt-0">
      <div className="mb-8 pb-8 flex items-center border-b border-gray-600">
        ...
        />
        <div className="ml-5">
          <span className="block text-3xl font-semibold text-white">Pro Plan</span>
          <span>
      ...
      <ul className="mb-10 font-medium text-xl">
        ...
        <li className="flex mb-6">
          <img src="https://res.cloudinary.com/williamsondesign/check-white.svg" />
          <span className="ml-3">
            Advanced<span className="text-white">Integrations</span>
          </span>
        </li>
        <li className="flex">
          <img src="https://res.cloudinary.com/williamsondesign/check-white.svg" />
      ...
      <a
        href="#/"
        className="flex justify-center items-center bg-green-400 rounded-xl py-6 px-4 text-center text-white text-2xl"
      >
        Choose Plan
        <img
          src="https://res.cloudinary.com/williamsondesign/arrow-right.svg"
    ...
    <div className="w-full flex-1 mt-8 p-8 order-3 bg-white shadow-xl rounded-3xl sm:w-96 lg:w-full lg:order-3 lg:rounded-l-none">
      <div className="mb-7 pb-7 flex items-center border-b border-gray-300">
        ...
        />
        <div className="ml-5">
          <span className="block text-2xl font-semibold">Business Plan</span>
          <span>
            <span className="font-medium text-gray-500 text-xl align-top">
              ₹ 
            </span>
      ...
      <ul className="mb-7 font-medium text-gray-500">
        ...
        <li className="flex text-lg">
          <img src="https://res.cloudinary.com/williamsondesign/check-grey.svg" />
          <span className="ml-3">Free initial 
