        ...
        <footer className="pt-10 bg-gray-800">
            <div className="max-w-screen-xl mx-auto px-4 md:px-8">
                        ...
                        <form onSubmit={(e) => e.preventDefault()} className="flex items-center gap-x-3 md:justify-end">
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    className="w-full pl-12 pr-3 py-2 text-gray-500 bg-white outline-none border focus:border-green-400 shadow-sm rounded-lg"
                                />
                            </div>
                            <button className="block w-auto py-3 px-4 font-medium text-sm text-center text-white bg-green-400 hover:bg-green-600 active:bg-green-700active:shadow-none rounded-lg shadow">
                                Subscribe
                            </button>
                        </form>
                    </div>
                ...
                <div className="mt-10 py-10 border-t border-gray-700 items-center justify-between sm:flex">
                    <p className="text-gray-300">© 2024 JustPrompt All rights reserved.</p>
