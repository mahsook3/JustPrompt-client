...
export default function Testimonies() {
      ...
      <div className="max-w-6xl mx-8 md:mx-10 lg:mx-20 xl:mx-auto">
        <div className="transition duration-500 ease-in-out transform scale-100 translate-x-0 translate-y-0 opacity-100">
          <div className="mb-12 space-y-5 md:mb-16 md:text-center">
            ...
            <h1 className="mb-5 text-3xl font-semibold text-green-400 md:text-center md:text-5xl">
              It's not just us.
            </h1>
  ...
  {testimoniesData.map((testimony, index) => (
    <div key={index} className="hover:shadow-indigo-300 hover:shadow-lg rounded-lg border flex flex-col">
      <div className="flex justify-center items-start flex-col p-5 flex-grow">
        ...
        <div className="flex justify-center items-start flex-col text-left gap-5">
          ...
          <div>
            <h3 className="text-base font-semibold">{testimony.name}</h3>
